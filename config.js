...
module.exports = {
    ...
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? '🙇 : ```HEY, I AM ALIVE!```' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/47821071665c45aadfdca.jpg' : process.env.ALIVE_LOGO,
