...
module.exports = {
    ...
    CAPTIONS: process.env.CAPTIONS === undefined ? 'nothing' : process.env.CAPTIONS,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT_NAME: process.env.BOT_NAME === undefined ? '2022' : process.env.BOT_NAME,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkFYiN_Q2W6-aKza0AZU6TkpJQCDrM6aRa4w&usqp=CAU' : process.env.MENU_LOGO,
