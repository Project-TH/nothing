...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'nekobin', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'nekobin', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'nekobin', fromMe: true, desc: Lang.NEKO_DESC, dontAddCommandList: true}, (async (message, match) => {
